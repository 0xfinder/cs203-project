...
public class ForumMediaController {
    ...
    public ResponseEntity<?> signedUrl(@RequestBody Map<String, Object> body) throws IOException, InterruptedException {
        ...
        String url = String.format("%s/storage/v1/object/sign/%s/%s?expiresIn=%d", supabaseUrl, bucket, path, expires);
