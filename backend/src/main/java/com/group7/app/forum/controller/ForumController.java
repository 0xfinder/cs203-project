...
public class ForumController {
    ...
    public ForumController(QuestionService questionService,
    ...
    public ResponseEntity<List<QuestionResponse>> getAllQuestions(
        ...
        List<QuestionResponse> result = questionService.getAllQuestions().stream()
    ...
    public ResponseEntity<QuestionResponse> postQuestion(
        ...
        q.setAuthor(user.getDisplayName() != null ? user.getDisplayName() : user.getEmail().split("@")[0]);
    ...
    public ResponseEntity<Void> deleteQuestion(
        ...
        if (!user.getId().equals(q.getAuthorId())
            ...
            throw new ResponseStatusException(HttpStatus.FORBIDDEN, "Not allowed to delete this question");
        }
    ...
    public ResponseEntity<List<AnswerResponse>> getAnswers(
            ...
            @AuthenticationPrincipal Jwt jwt) {
        UUID userId = jwt != null ? parseUserId(jwt) : null;
        List<AnswerResponse> result = answerService.getAnswersForQuestion(id).stream()
    ...
    public ResponseEntity<AnswerResponse> postAnswer(
        ...
        a.setAuthor(user.getDisplayName() != null ? user.getDisplayName() : user.getEmail().split("@")[0]);
    ...
    public VoteSummary clearQuestionVote(
            @PathVariable Long id,
            @AuthenticationPrincipal Jwt jwt) {
        User user = resolveUser(jwt);
    ...
    private User resolveUser(Jwt jwt) {
        ...
        return userService.findById(userId)
                .orElseGet(() -> userService.createFromAuth(userId, email));
    }
