...
function ProfilePage() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      // Do not persist signed URLs in user metadata — they expire.
      // We only store the storage `avatar_path` and generate signed URLs
      // at runtime when displaying the avatar.
