...
import { ContributorLessonsPanel } from "@/features/lessons/components/contributor-lessons-panel";
    ...
    <AppPageShell contentClassName="max-w-6xl">
      <div className="space-y-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold">Contributor Workspace</h1>
            <p className="text-sm text-muted-foreground">
              Create new submissions and keep your lesson drafts, pending reviews, and revisions in
              one place.
            </p>
          </div>
        </div>
        ...
        <Tabs defaultValue="create" className="space-y-6">
          <TabsList className="grid w-full grid-cols-2 rounded-xl bg-muted/70 p-1 sm:w-[360px]">
            ...
            <TabsTrigger value="my-lessons" className="rounded-lg">
              My Lessons
            </TabsTrigger>
          </TabsList>
          ...
          <TabsContent value="my-lessons" className="mt-0">
            <ContributorLessonsPanel />
          </TabsContent>
        </Tabs>
      </div>
    </AppPageShell>
