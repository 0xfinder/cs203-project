    ...
    return (
        <div className="flex-1 p-8">
            <div className="max-w-4xl mx-auto">
                ...
                <p className="text-muted-foreground mb-8">Track your approved lingo and community engagement</p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                    ...
                    <Card>
                        <CardHeader className="pb-2">
                            <CardTitle className="text-sm font-medium text-muted-foreground">Total Upvotes</CardTitle>
                        </CardHeader>
                        <CardContent>
                    ...
                    <Card>
                        <CardHeader className="pb-2">
                            <CardTitle className="text-sm font-medium text-muted-foreground">Total Downvotes</CardTitle>
                        </CardHeader>
                        <CardContent>
                            <div className="flex items-center gap-2">
                ...
                {sortedContents.length === 0 ? (
                    <Card>
                        <CardContent className="pt-6">
                            <p className="text-center text-muted-foreground">
                                You haven't submitted any approved lingo yet. Head to the <strong>Add</strong> page to get started!
                            </p>
                        </CardContent>
                    </Card>
                ) : (
                    <div className="space-y-4">
                        {sortedContents.map((item) => {
                            ...
                            const scoreColor = score > 0 ? "text-green-600" : score < 0 ? "text-red-600" : "text-muted-foreground";
                                    ...
                                    <CardHeader>
                                        <div className="flex items-start justify-between">
                                            ...
                                            <div className="ml-4 text-right">
                                                <div className={`text-2xl font-bold ${scoreColor}`}>{score > 0 ? '+' : ''}{score}</div>
                                        ...
                                        <div className="space-y-3">
                                            {item.content.example && (
                                                <div>
                                                    ...
                                                    <p className="text-sm italic text-muted-foreground">"{item.content.example}"</p>
                                                </div>
                                            )}
