...
import { usePendingContentsPaginated } from "@/features/content/useContentData";
    ...
    <div className="flex-1 p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-2 gap-6 p-8">
          <Card
            key="CSD"
            className="group cursor-pointer h-64 border-2 border-gray-200 hover:border-blue-500 hover:shadow-xl transition-all duration-300 overflow-hidden flex flex-col justify-between p-6"
          >
            <div className="mb-4">
