...
import { usePendingContentsPaginated, useApproveContent, useRejectContent } from "@/features/content/useContentData";
        ...
        <div className="flex-1 p-8">
            <div className="max-w-4xl mx-auto">
                ...
                <p className="text-gray-600 mb-6">
                    Page {page + 1} of {totalPages} • Showing {pendingContents.length} of {totalElements} pending{" "}
